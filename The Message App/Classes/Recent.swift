...
func restartRecentChat(recent: NSDictionary) {
    ...
    if recent[kTYPE] as! String == kGROUP {
        ...
        createRecent(members: recent[kMEMBERSTOPUSH] as! [String], chatRoomId: recent[kCHARTROOMID] as! String, withUserUserName: recent[kWITHUSERFULLNAME] as! String, type: kGROUP, users: nil, avatarOfGroup: recent[kAVATAR] as? String)
